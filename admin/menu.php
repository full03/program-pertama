...
<head>
    ...
    <title>Menu Utama - Absensi RFID</title>
...
<div class="sidebar" id="sidebar">
    ...
    <ul>
        ...
        <li>
            <a href="halaman_siswa.php" class="<?php echo basename($_SERVER['PHP_SELF']) == 'halaman_siswa.php' ? 'active' : ''; ?>">
                <div class="menu-label">
        ...
        <li>
            <a href="scan.php" class="<?php echo basename($_SERVER['PHP_SELF']) == 'scan.php' ? 'active' : ''; ?>">
                <div class="menu-label">
    ...
    <div class="user-profile">
        <div class="user-info" id="profileInfo" onclick="openEditProfile()">
            <div class="user-avatar">
                ...
                if (isset($foto_user) && $foto_user !== '../images/default-user.png' && file_exists($foto_user)): 
                ?>
